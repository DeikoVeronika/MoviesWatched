...
namespace MoviesWatchedInfrastructure.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,LanguageId,Duration,MovieImage,ReviewDate")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,LanguageId,Duration,MovieImage,ReviewDate")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
